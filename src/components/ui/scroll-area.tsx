...
>(({ className, children, orientation, ...props }, ref) => (
  <ScrollAreaPrimitive.Root
    ...
    {...props}
  >
    <ScrollAreaPrimitive.Viewport className="size-full grow rounded-[inherit]">
      {children}
...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="bg-gray-300 relative flex-1 rounded-full" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
));
